<div class="full-content-items">
	<div class="left-add-box" style="max-height: 85vh">
		<div>
			<a href="" target="_blank"><img class="left-add" src="pv/images/add/one.png"></a>
		</div>
	</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-feature">
							<div class="feature-head">
								<img src="pv/images/feature1.jpg" alt="#">
							</div>
					...
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-feature">
							<div class="feature-head">
								<img src="pv/images/feature2.jpg" alt="#">
							</div>
					...
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-feature">
							<div class="feature-head">
								<img src="pv/images/feature3.jpg" alt="#">
							</div>
								...
								<div class="enroll-form">
									...
									<form class="form" action="#">
										...
										<div class="form-group">
											...
											<input name="phone" type="phone" placeholder="+88017........">
										</div>
										<div class="form-group">
						...
						<div class="course-slider">
							...
							<div class="single-course">
								<div class="course-head overlay">
									<img src="pv/images/course/course1.jpg" alt="#">
							...
							<div class="single-course">
								<div class="course-head overlay">
									<img src="pv/images/course/course2.jpg" alt="#">
									<a href="course-single.html" class="btn"><i class="fa fa-link"></i></a>
								</div>
								<div class="single-content">
							...
							<div class="single-course">
								<div class="course-head overlay">
									<img src="pv/images/course/course3.jpg" alt="#">
									<a href="course-single.html" class="btn"><i class="fa fa-link"></i></a>
								</div>
								<div class="single-content">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-6">
						...
						<div class="single-team teacher-one">
							<img src="pv/images/team/team1.jpg" alt="#">
					...
					<div class="col-lg-3 col-md-6 col-6">
						<!-- Single Team -->
						<div class="single-team active teacher-two">
							<img src="pv/images/team/team2.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-lg-3 col-md-6 col-6">
						<!-- Single Team -->
						<div class="single-team teacher-three">
							<img src="pv/images/team/team3.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-lg-3 col-md-6 col-6">
						<!-- Single Team -->
						<div class="single-team teacher-four">
							<img src="pv/images/team/team4.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-12">
						<div class="testimonial-slider">
							...
							<div class="single-testimonial">
								<img src="pv/images/testimonial1.jpg" alt="#">
							...
							<!-- Single Testimonial -->
							<div class="single-testimonial">
								<img src="pv/images/testimonial2.jpg" alt="#">
								<div class="main-content">
							...
							<!-- Single Testimonial -->
							<div class="single-testimonial">
								<img src="pv/images/testimonial3.jpg" alt="#">
								<div class="main-content">
									<h4 class="name">Sanavce Faglane</h4>
									<p>Nulla cursus a metus vel placerat. Fusce malesuada volutpat pretium. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus velit libero, viverra quis euismod vel pellentesque at tortor. Donec</p>
								</div>
							...
							<!-- Single Testimonial -->
							<div class="single-testimonial">
								<img src="pv/images/testimonial4.jpg" alt="#">
								<div class="main-content">
									<h4 class="name">Jansan Kate</h4>
									<p>Nulla cursus a metus vel placerat. Fusce malesuada volutpat pretium. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus velit libero, viverra quis euismod vel pellentesque at tortor. Donec</p>
								</div>
						...
						<div class="event-slider">
							...
							<div class="single-event">
								<div class="head overlay">
									<img src="pv/images/events/event1.jpg" alt="#">
							...
							<div class="single-event">
								<div class="head overlay">
									<img src="pv/images/events/event2.jpg" alt="#">
							...
							<div class="single-event">
								<div class="head overlay">
									<img src="pv/images/events/event3.jpg" alt="#">
						...
						<div class="blog-slider">
							...
							<div class="single-blog">
								<div class="blog-head overlay">
									...
									<img src="pv/images/blog/blog1.jpg" alt="#">
								</div>
								<div class="blog-content">
									...
									<p>Vivamus volutpat eros pulvinar velit laoreet, sit amet egestas erat dignissim. Et harum quidem rerum facilis est et expedita distinctio.Vivamus volutpat eros pulvinar velit laoreet, sit amet egestas erat dignissim.</p>
									<div class="button">
							...
							<div class="single-blog">
								<div class="blog-head overlay">
									...
									<img src="pv/images/blog/blog2.jpg" alt="#">
								</div>
								<div class="blog-content">
							...
							<div class="single-blog">
								<div class="blog-head overlay">
									...
									<img src="pv/images/blog/blog3.jpg" alt="#">
								</div>
								<div class="blog-content">
							...
							<div class="single-blog">
								<div class="blog-head overlay">
									...
									<img src="pv/images/blog/blog4.jpg" alt="#">
								</div>
								<div class="blog-content">
									<h4 class="blog-title"><a href="blog-single.html">Our Student Have sit amet egestas</a></h4>
									<div class="blog-info">
	...
	<div class="right-add-box">
		<div>
			<a href="" target="_blank"><img class="right-add" src="pv/images/add/add3.png"></a>
		</div>
	</div>
</div>

<div class="bottom-add">
	<a href="" target="_blank"><img src="pv/images/add/add5.png" width="100%" height="96px" style="margin: 20px 0; padding: 0 50px;" class="bottom-add-img"></a>
</div>