            ...
            <div id="container_demo" >
                ...
                <div id="wrapper">
                    <div class="animate form">
                        <form method="post" action="{{ route('upcoming-events.store')}}" enctype="multipart/form-data"> 
                            @csrf

                            <h1>{{ auth()->user()->abbreviation . ' Event Area' }}</h1> 

                            
                            <p> 
                                <label for="event_title"> Event Title: </label>
                                <input id="event_title" value="{{old('event_title')}}" name="event_title" required="required" type="text" placeholder="Enter the event title" />
                            </p>
                            ...
                            <div style="width: 45%;float: left;margin-right: 5%;">
                                <div style="width: 45%;float: left;margin-right: 8%;">
                                    <p> 
                                        ...
                                        <input id="event_date" name="event_date" value="{{ old('event_date') }}" type="date"/>
                                    </p> 
                                </div>
                                ...
                                <div style="width: 45%;float: left;">
                                    <p> 
                                        ...
                                        <input id="event_start" name="event_start" required="required" type="time"/>
                                    </p> 
                                </div>
                            </div>
                            ...
                            <div style="width: 48%;float: left;">
                                <div style="width: 45%;float: left;margin-right: 8%;">
                                    <p> 
                                        ...
                                        <input id="event_end" value="{{ old('event_end') }}" name="event_end" required="required" type="time"/>
                                    </p> 
                                </div>
                            ...
                            <p> 
                                ...
                                <textarea id="event_description" name="event_description" required="required" rows="10" cols="60">{{old('event_description')}}</textarea>
                            </p>
